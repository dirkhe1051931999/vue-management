...
export default {
  ...
  methods: {
    ...
    addTag() {
      this.$msgBox.showMsgBox(_msg_.messagebox.addTag)
        .then(async (val) => {
    ...
    editTag(tag, index) {
      this.$msgBox.showMsgBox(Object.assign(_msg_.messagebox.editTag, { inputValue: tag.name }))
        .then(async (val) => {
    ...
    deleteTag(tag, index) {
      this.$msgBox.showMsgBox(_msg_.messagebox.deleteTag)
        .then(async () => {
